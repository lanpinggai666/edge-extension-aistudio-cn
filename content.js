...
const i18n = {
    ...
    "Get started": "开始使用",
	"Code and Chat": "代码与聊天",
	"Test out our most advanced and newest models.": "尝试我们最新，最先进的模型。",
	"Build chatbots, agents, and code with Gemini 3.": "使用 Gemini 3 构建聊天机器人、Agent或编写代码。",
	"Explore Google models": "探索Google大模型",
	"Image Generation": "图像生成",
	"Create and edit images with Nano Banana and Imagen.": "用Nano Banana和Imagen生成和编辑图像。",
	"Video Generation": "视频生成",
	"Generate videos with Veo models, our state of the art video generation models.": "使用我们最先进的视频生成模型——Veo 模型来生成视频。",
	...
	"Release date": "发布日期",
	"Our most intelligent model built for speed, combining frontier intelligence with superior search and grounding.": "我们打造的快速，最智能的模型，融合了前沿智能与卓越的搜索及信息溯源能力。",
	"Our latest SOTA reasoning model with unprecedented depth and nuance, and powerful multimodal understanding and coding capabilities": "我们最新、最先进的推理模型，具备前所未有的深度与细腻度，以及强大的多模态理解与编程能力。",
	"Text, image and video": "文本，图像和视频",
	"Audio": "音频",
	"Text": "文本",
	"Our most cost-efficient model, optimized for high-volume agentic tasks, translation, and simple data processing.": "我们最具性价比的模型，专门优化大批量的Agent任务、翻译以及简单数据处理",
	"Start building": "开始构建",
	"Pro-level visual intelligence with Flash-speed efficiency and reality-grounded generation capabilities.": "具备专业级的视觉智能，兼具极速的运行效率与基于真实事实的生成能力。",
    "Submit feedback": "提交反馈",
	"Your response is Feedback under the Terms, and may be used to improve our services subject to our Privacy Policy. Do not submit personal, sensitive, or confidential information.": "根据相关条款，您的回复将被视为反馈，我们可依据隐私政策使用这些反馈来改进我们的服务。请勿提交个人、敏感或机密信息。",
	"Messages": "信息",
	"Parameters": "参数",
	"Response": "回答",
	"your ideas with Gemini": "用Gemini构建您的想法",
};
